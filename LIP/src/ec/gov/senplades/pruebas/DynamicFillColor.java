 ...
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.7-M0/demo/example/src/main/java/org/geotools/demo/filter/function/DynamicFillColor.java $
 */
public class DynamicFillColor {
    ...
    private void demo() throws Exception {
        URL url = DynamicFillColor.class.getResource("file://c:/java/mapa/data-v1_2/countries.shp"); 	
