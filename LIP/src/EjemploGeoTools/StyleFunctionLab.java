...
public class StyleFunctionLab {
    ...
    private Style createStyle(FeatureSource featureSource, String attributeName)
        ...
        /*if( filterFactory.evaluate( feature ) ){
            // the feature was "selected" by the filter
            System.out.println( "Selected "+ feature.getId();
        } */

       System.out.println(""); 
       System.out.println(filterFactory.property(attributeName)); 
